...
describe('Deobfuscation tests', () => {
  it('TP-1: Augmented array replacements', () => {
...
console.log('a', 'b');`;
  ...
  it('TP-2: Compute definite binary expressions', () => {
    const code = '"2" + 3 - "5" * 0 + "1"';
    const expected  = '\'231\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TN-1: Do not replace modified member expressions', () => {
    const code = `var l = [];
const b = l.length * 2;
const c = l.length + 1;
var v = l[b];
...
l[c] = v;`;
  ...
  it('TP-9: Replace deterministic if statement', () => {
    const code = 'if(true){a;}if(false){b}if(false||c){c}if(true&&d){d}';
    const expected  = 'a;\nif (c) {\n  c;\n}\nif (d) {\n  d;\n}';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-10: Replace function calls with unwrapped identifier - arrow functions', () => {
    const code = 'const x = () => String; x().fromCharCode(97);';
    const expected  = 'const x = () => String;\n\'a\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-11: Replace function calls with unwrapped identifier - function declarations', () => {
...
'a';`;
  ...
  it('TP-12: Replace function evals - eval(string)', () => {
    const code = 'eval("console.log");';
    const expected  = 'console.log;';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-13: Replace function evals in call expressions - eval(string)(args)', () => {
    const code = 'eval("atob")("c3VjY2Vzcw==");';
    const expected  = '\'success\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-14: Replace identifier with fixed assigned value', () => {
...
function v(arg) {
  ...
  it('TP-15: Replace literal proxies', () => {
    const code = 'const b=\'hello\'; console.log(b + \' world\');';
    const expected  = 'const b = \'hello\';\nconsole.log(\'hello world\');';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-16: Replace local calls proxy - arrow functions', () => {
...
function c() {
  ...
  it('TP-17: Replace local calls proxy - function declarations', () => {
...
function c() {
  ...
  it('TP-18: Replace local calls with values - immediate', () => {
...
'value';`;
  ...
  it('TP-19: Replace local calls with values - nested', () => {
...
4;`;
  ...
  it('TP-20: Replace local member expressions property reference with value', () => {
...
console.log('hello world');`;
  ...
  it('TP-21: Replace local member expressions proxy - chained proxies', () => {
    const code = 'const a = ["hello"], b = a[0], c = b; console.log(c);';
    const expected  = 'const a = [\'hello\'];\nconst b = \'hello\';\nconst c = \'hello\';\nconsole.log(\'hello\');';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-22: Replace local member expressions proxy - member assignment', () => {
    const code = 'const a = ["hello"], b = a[0];';
    const expected  = 'const a = [\'hello\'];\nconst b = \'hello\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-23: Replace member expression references with values', () => {
...
console.log('hello world');`;
  ...
  it('TP-24: Replace reference proxy', () => {
...
console.log('hello world');`;
  ...
  it('TP-25: Replace wrapped functions with return statement', () => {
  ...
  it('TP-26: Resolve builtin call expressions: btoa & atob', () => {
    const code = 'atob(\'dGVzdA==\'); btoa(\'test\');';
    const expected  = '\'test\';\n\'dGVzdA==\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-27: Resolve definite member expressions', () => {
    const code = '\'1234567890\'[3]';
    const expected  = '\'4\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-28: Resolve deterministic conditional expressions', () => {
    const code = '(true ? \'o\' : \'x\') + (false ? \'X\' : \'k\');';
    const expected  = '\'ok\';';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-29: Resolve directly assigned member expressions', () => {
...
console.log('35');`;
  ...
  it('TP-30: Resolve external references with context', () => {
...
function b() {
  ...
  it('TP-31: Resolve function constructor calls', () => {
...
const c = function (a, b) {
  ...
  it('TP-32: Resolve injected prototype method calls', () => {
...
'secret hello';`;
  ...
  it('TP-33: Resolve member expression local references with unary expressions correctly', () => {
    const code = 'const a = [\'-example\', \'-3\', \'-Infinity\']; a[0]; a[1]; a[2];';
    const expected  = 'const a = [\n  \'-example\',\n  \'-3\',\n  \'-Infinity\'\n];\n\'-example\';\n-\'3\';\n-Infinity;';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-34: Resolve member expression references with context', () => {
...
const b = 3;`;
  ...
  it('TP-35: Unwrap function shells', () => {
  ...
  it('TP-36: Verify correct context for function declaration', () => {
    const code = 'function a(v) {return v + \'4\'}; if (a(0)) {console.log(a(18));}';
    const expected  = 'function a(v) {\n  return v + \'4\';\n}\nconsole.log(\'184\');';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-37: Verify correct context for function variable', () => {
    const code = 'let a = function (v) {return v + \'4\'}; if (a(0)) {console.log(a(18));}';
    const expected  = 'let a = function (v) {\n  return v + \'4\';\n};\nconsole.log(\'184\');';
    const result = getDeobfuscatedCode(code);
    assert.strictEqual(result, expected);
  });
  it('TP-38: Verify correct replacement of member expressions with literals', () => {
...
console.log(15, 'hello');`;
  ...
  it('TN-3: Verify random values remain untouched', () => {
